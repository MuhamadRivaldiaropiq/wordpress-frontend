...
const AddArticle = async (status) => {
    ...
    try {
        ...
        toast.add({ severity: 'success', summary: 'Success', detail: 'User Berhasil Ditambahkan', life: 2000 });
    } catch (error) {
        toast.add({ severity: 'error', summary: 'Error', detail: 'Gagal Menambahkan user!', life: 3000 });
                    ...
                    <div class="w-[47rem]">
                        <v-card>
                            ...
                            <div class="p-5">
                                ...
                                <input type="text" v-model="FormArticle.Title"
                                    ...
                                    required />
                                <button @click="OpenDialog(1)" type="button"
                                    class="bg-typography-4 rounded p-2 border border-secondary-3 text-xs mb-3"><i
